...
stationManagement.CHgainGAinit = CHgain;
% phyParams.P_ERP_MHz_LTEGA = phyParams.P_ERP_MHz_LTE;
% sinrManagement.P_RX_MHzGA = sinrManagement.P_RX_MHz;
...
%         stationManagement.A = 0.02*ones(1,3);
        ...
        stationManagement.BRidGA = stationManagement.BRid;
        stationManagement.NbeaconsTGA = stationManagement.NbeaconsT;
