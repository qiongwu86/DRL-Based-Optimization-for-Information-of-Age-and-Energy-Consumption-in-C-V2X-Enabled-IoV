...
if ~isempty(transmittingIDsLTE)
    ...
    if ~isempty(stationManagement.transmittingIDsLTEGA)
        sinrManagement.neighborsSINRaverageLTEGA = sinrManagement.neighPowerUsefulLTEGA ./ ...
            ( Pnoise + sinrManagement.neighPowerInterfDataLTEGA );
    
        % The average SINR for control is updateed
        sinrManagement.neighborsSINRsciAverageLTEGA = sinrManagement.neighPowerUsefulLTEGA ./ ...
            ( Pnoise + sinrManagement.neighPowerInterfControlLTEGA );
    end
